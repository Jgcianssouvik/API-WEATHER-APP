...
let oldTab = userTab;
const API_KEY = "3dacaa125343234a5a1edf7fbec7536f";
...
async function fetchUserWeatherInfo(coordinates) {
    ...
    //make grant container invvisible
    grantAccessContainer.classList.remove("active");
    //make loader visible
...
function renderWeatherInfo(weatherInfo) {
    ...
    //firstly we ghave to fetch the elements
...
function getLoaction() {
    if (navigator.geolocation) {
        ...
        // jastt show ans alert for no geolocation
    }
}
